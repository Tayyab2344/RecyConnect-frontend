...
class _BuyerOrdersScreenState extends State<BuyerOrdersScreen> {
  ...
  Future<void> _fetchOrders() async {
    ...
    try {
      final data = await _orderService.getOrders(role: 'buyer', limit: 50);
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('My Buy Orders', style: TextStyle(color: theme.appBarTheme.foregroundColor, fontWeight: FontWeight.bold)),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text('Seller: ${order.sellerName}', style: const TextStyle(fontSize: 14, color: AdminColors.textPrimary)),
              ],
            ),
